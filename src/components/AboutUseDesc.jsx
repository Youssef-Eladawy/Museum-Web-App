        ...
        <div className="row row-gap-4">
          ...
          <div className="col-lg-7  ">
            <div className="w-100 h-100 d-flex flex-column justify-content-center gap-1 px-4">
              <h5 className="text-uppercase mb-2 position-relative">
                About Us
              </h5>
              ...
              <div className="row row-gap-2">
                <div className="col-6">
                  <FaArrowRight /> First Class Flights
                </div>
                <div className="col-6">
                  <FaArrowRight /> 5 Star Accommodations
                </div>
                <div className="col-6">
                  <FaArrowRight /> 150 Premium City Tours
                </div>
                <div className="col-6">
                  <FaArrowRight /> Handpicked Hotels
                </div>
                <div className="col-6">
                  <FaArrowRight /> Latest Model Vehicles
                </div>
                <div className="col-6">
                  <FaArrowRight /> 24/7 Service
                </div>
              </div>
              <Link className="ReadMoreLink btn btn-primary rounded-5 align-self-start mt-5 px-5 py-3">
                Read More
              </Link>
            </div>
          </div>
