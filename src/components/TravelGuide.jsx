...
function TravelGuide() {
    ...
    <>
        <section className="travelGuideSection w-100 d-flex flex-column justify-content-center align-items-center  px-5 container my-5">
            <SectionTitle title={"Tour Guide"} sentence={"Meet Our Guide"} desc={""} />
                        ...
                        <div className="d-flex flex-column border rounded-3  overflow-hidden">
                            <div className="position-relative w-100">
                                ...
                                <div className=" d-flex justify-content-around gap-1 border border-1 rounded-5 border-primary-subtle p-2 position-absolute top-100 start-50 translate-middle bg-white z-3">
                                    <a href="" className="btn btn-square border border-2 rounded-circle text-light bg-dark pb-2"><FaFacebookF /></a>
                                    <a href="" className="btn btn-square border border-2 rounded-circle text-light bg-dark pb-2"><FaXTwitter /></a>
                                    <a href="" className="btn btn-square border border-2 rounded-circle text-light bg-dark pb-2"><IoLogoInstagram /></a>
                                    <a href="" className="btn btn-square border border-2 rounded-circle text-light bg-dark pb-2"><FaLinkedinIn /></a>
                                </div>
                            </div>
